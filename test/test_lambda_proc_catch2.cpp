...
void test_lambda_proc_script_against_file(const char* script_path, const char* expected_output_path) {
    ...
    INFO("Failed to execute lambda.exe run with script: " << script_path);
