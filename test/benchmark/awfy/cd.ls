...
// Voxel hashing
// =====================================================
pn voxel_hash_xy(px, py, var out) {
...
// =====================================================
pn recurse_draw(voxel_map, seen_tree, vx, vy, p1x, p1y, p2x, p2y, motion_idx) {
...
pn handle_new_frame(var stateTree, frame) {
    var motions = vec_new()
