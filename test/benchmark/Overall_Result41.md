...
| AWFY | 14 | 14 | 13 | 14 | 14 | 14 | 14 | 1.55x | 1.25x | 0.09x | 18.2x | 5.23x |
...
| JetStream | 6 | 5 | 5 | 6 | 6 | 6 | 6 | 5.43x | 3.65x | 0.29x | 44.6x | 12.0x |
| Text | 7 | 7 | 7 | 7 | 7 | 7 | 7 | 2.28x | 3.01x | 0.14x | 48.9x | 12.1x |
| **Overall** | 63 | 62 | 61 | 63 | 63 | 63 | 63 | 1.29x | 1.15x | 0.17x | 20.4x | 7.22x |
...
|---|---:|---:|---:|---:|---:|
| v38-comparable (without the four text extensions) | 59 | 0.95x | 1.13x | 6.24x | 57 |
| complete current suite | 63 | 1.15x | 1.29x | 6.81x | 61 |
...
- **MIR (typed) / C2MIR geomean:** 6.81x over 61 of 63 rows
...
| beng/knucleotide | 5.32 | 0.281 | 18.9x |

---

### Notable Results

- Missing timings: **3** cells
- MIR (typed) missing: awfy/havlak (wrong_output), jetstream/navier_stokes (exit_-11)
- MIR (untyped) missing: jetstream/navier_stokes (exit_-11)
...
| havlak | macro | 68.8 [66.5–69.6] | --- | 1.83 [1.79–1.88] | 18.39s [18.29s–18.41s] | 3.33s [3.29s–3.36s] | 94.8 [93.8–95.4] | 0.73x | --- | 0.02x | 194x | 35.1x |
...
| navier_stokes | numeric | --- | --- | 47.1 [47.0–48.4] | 349.7 [347.2–352.9] | 98.7 [98.5–98.9] | 14.0 [13.9–14.1] | --- | --- | 3.36x | 25.0x | 7.04x |
...
| AWFY | 14 | 14 | 13 | 14 | 14 | 14 | 14 | 0.99x | 1.15x | 0.91x | 4.60x | 0.79x |
...
| JetStream | 6 | 5 | 5 | 6 | 6 | 6 | 6 | 2.90x | 4.53x | 0.91x | 14.8x | 3.67x |
| Text | 7 | 7 | 7 | 7 | 7 | 7 | 7 | 3.12x | 4.28x | 0.80x | 31.8x | 6.49x |
| **Overall** | 63 | 62 | 61 | 63 | 63 | 63 | 63 | 0.93x | 1.03x | 0.92x | 4.92x | 1.26x |
...
| havlak | macro | 159.0 [158.1–159.2] | --- [114.2–114.8] | 54.0 [53.7–54.4] | 18.72s [18.61s–18.72s] | 3.34s [3.31s–3.37s] | 142.5 [141.8–142.5] | 1.12x | --- | 0.38x | 131x | 23.5x |
...
| navier_stokes | numeric | --- [194.8–197.5] | --- [189.4–191.6] | 95.5 [95.4–97.6] | 524.2 [521.6–529.9] | 109.8 [109.3–109.8] | 61.1 [60.3–61.2] | --- | --- | 1.56x | 8.58x | 1.80x |
