// test_latexml_compare_gtest.cpp - Compare Lambda's TeX pipeline output against hybrid HTML references
//
// This test suite validates Lambda's LaTeX-to-HTML pipeline by comparing
// its output against hybrid HTML reference files generated by generate_hybrid_refs.py.
//
...
//   python3 utils/generate_hybrid_refs.py --clean
//
// To run tests:
//   ./test/test_latexml_compare_gtest.exe --gtest_filter="Baseline*"   # Must-pass
//   ./test/test_latexml_compare_gtest.exe --gtest_filter="Extended*"   # WIP
...
// Format: relative path from test/latexml/fixtures/ without .tex extension
// ============================================================================
...
static std::vector<std::string> collect_all_fixtures() {
    ...
    fs::path fixtures_dir = "test/latexml/fixtures";
    fs::path expected_dir = "test/latexml/expected";
...
fs::path TexHtmlCompareTest::fixtures_dir = "test/latexml/fixtures";
fs::path TexHtmlCompareTest::expected_dir = "test/latexml/expected";
