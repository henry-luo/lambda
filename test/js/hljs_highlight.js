// Highlight.js Support Tests
// Tests highlight.js v11.9.0 loading, language registration, and highlighting
// under the Lambda JS engine.

// === Shims for CommonJS/browser environment ===
...
// === Test 2: Core API types ===
console.log(typeof hljs.highlight);
console.log(typeof hljs.highlightAuto);
console.log(typeof hljs.listLanguages);
console.log(typeof hljs.getLanguage);
console.log(typeof hljs.registerLanguage);

// === Test 3: Language count ===
var langs = hljs.listLanguages();
console.log(langs.length);

// === Test 4: Key languages registered ===
console.log(hljs.getLanguage("javascript") !== undefined);
console.log(hljs.getLanguage("python") !== undefined);
console.log(hljs.getLanguage("css") !== undefined);
console.log(hljs.getLanguage("xml") !== undefined);
console.log(hljs.getLanguage("json") !== undefined);
console.log(hljs.getLanguage("java") !== undefined);
console.log(hljs.getLanguage("cpp") !== undefined);
console.log(hljs.getLanguage("bash") !== undefined);
console.log(hljs.getLanguage("yaml") !== undefined);
console.log(hljs.getLanguage("ruby") !== undefined);

// === Test 5: Language metadata ===
var jsLang = hljs.getLanguage("javascript");
console.log(jsLang.name);
var pyLang = hljs.getLanguage("python");
console.log(pyLang.name);

// === Test 6: Highlight JavaScript ===
try {
    var jsResult = hljs.highlight('var x = 42;', { language: "javascript" });
    console.log(jsResult.language);
    console.log(jsResult.value.indexOf("<span") >= 0);
} catch(e) {
    console.log("js-highlight-error");
    console.log("js-highlight-error");
}

// === Test 7: Highlight Python ===
try {
    var pyResult = hljs.highlight('def hello():\n    return 42', { language: "python" });
    console.log(pyResult.language);
    console.log(pyResult.value.indexOf("<span") >= 0);
} catch(e) {
    console.log("py-highlight-error");
    console.log("py-highlight-error");
}

// === Test 8: Highlight CSS ===
try {
    var cssResult = hljs.highlight('.foo { color: red; }', { language: "css" });
    console.log(cssResult.language);
    console.log(cssResult.value.indexOf("<span") >= 0);
} catch(e) {
    console.log("css-highlight-error");
    console.log("css-highlight-error");
}

// === Test 9: Highlight JSON ===
try {
    var jsonResult = hljs.highlight('{"key": "value", "n": 42}', { language: "json" });
    console.log(jsonResult.language);
    console.log(jsonResult.value.indexOf("<span") >= 0);
} catch(e) {
    console.log("json-highlight-error");
    console.log("json-highlight-error");
}

// === Test 10: Auto-detection ===
try {
    var autoResult = hljs.highlightAuto('{"name":"test","value":123}');
    console.log(typeof autoResult.value === "string");
    console.log(typeof autoResult.language === "string");
} catch(e) {
...
try {
    hljs.highlight("code", { language: "nonexistent_xyz" });
    console.log(false);
} catch(e) {
    console.log(true);
}
