...
console.log(typeof stat.mode);
console.log(typeof stat.uid);
console.log(typeof stat.gid);
console.log(typeof stat.nlink);
console.log(typeof stat.dev);
console.log(typeof stat.rdev);
console.log(typeof stat.blksize);
console.log(typeof stat.blocks);
console.log(typeof stat.atimeMs);
console.log(typeof stat.mtimeMs);
console.log(typeof stat.ctimeMs);
console.log(typeof stat.birthtimeMs);
console.log(typeof stat.atime.getTime);
console.log(typeof stat.mtime.getTime);
console.log(typeof stat.ctime.getTime);
console.log(typeof stat.birthtime.getTime);
console.log(stat.isSymbolicLink());
console.log(stat.isBlockDevice());
console.log(stat.isCharacterDevice());
...
console.log(typeof statBig.atimeMs);
console.log(typeof statBig.ctimeMs);
console.log(typeof statBig.birthtimeMs);
