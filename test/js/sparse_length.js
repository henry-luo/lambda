...
// (arr[20000]) returns undefined because of Js58 P0's bounds-check guard,
...
console.log("before-arr[20000]", arr[20000]);

arr.length = 100;
console.log("after-length", arr.length);
console.log("after-arr[20000]", arr[20000]);
...
console.log("ext-arr[20000]", arr[20000]);   // should stay undefined (was already deleted)
