...
static void test_jsx_roundtrip_file(const char* filename) {
    ...
    EXPECT_STREQ(normalized_original, normalized_formatted) << "JSX roundtrip failed for " << filename;
...
TEST_F(JsxRoundtripTest, SimpleElement) {
    test_jsx_roundtrip_file("simple.jsx");
}

TEST_F(JsxRoundtripTest, ComponentWithProps) {
    test_jsx_roundtrip_file("component.jsx");
}

TEST_F(JsxRoundtripTest, JsxFragment) {
    test_jsx_roundtrip_file("fragment.jsx");
}

TEST_F(JsxRoundtripTest, NestedElements) {
    test_jsx_roundtrip_file("nested.jsx");
}

TEST_F(JsxRoundtripTest, SelfClosingTags) {
    test_jsx_roundtrip_file("self_closing.jsx");
}

// Test JSX expressions parsing
TEST(JsxParsingTest, JsxExpressions) {
...
// Test JSX attributes
TEST(JsxParsingTest, JsxAttributes) {
