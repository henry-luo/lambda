...
// An untyped container may evolve its shape. Typed array contracts reject
// these stores (covered by the enforcement-negative tests), so this keeps the
// representation-transition regression explicitly outside a typed boundary.
pn convert_inside(a) {
...
pn main() {
    ...
    print(fill_diagonal(fill(6, 1.25), 2, 2) ++ "\n")
