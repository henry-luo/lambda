...
pn test_float_image_idiom() {
    ...
    img[img < 3.0] = 0.0              // the skimage idiom: zero dark pixels -> [0, 0, 3, 4, 5]
    print(img[0]); print(" "); print(img[2]); print(" "); print(img[4]); print("\n")
}

pn test_block_values() {
    var b = [10, 20, 30, 40, 50]
    b[b > 25] = [100, 200, 300]       // selected slots take 100,200,300 in order
    print(b[2]); print(" "); print(b[3]); print(" "); print(b[4]); print("\n")
}

pn test_2d_mask() {
    var m = [[10, 200, 30], [240, 50, 250]]
    m[m > 100] = 0                    // threshold-zero bright pixels across the whole image
