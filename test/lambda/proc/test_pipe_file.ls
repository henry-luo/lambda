...
pn main() {
    ...
    print(result3);
    print("\n");
    let text_content = input("./temp/lambda_test_text.txt", "text")^;
    ...
    let result8 = output(data8, "./temp/lambda_test_output_json.json", {format: "json"})^;
    print("Test 8 - output json bytes: ");
    print(result8);
    print("\n");
    let content8 = input("./temp/lambda_test_output_json.json", "text")^;
