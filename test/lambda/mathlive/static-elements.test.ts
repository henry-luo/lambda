...
import { convertLatexToMarkup, convertAsciiMathToLatex, convertMathJsonToLatex } from '../../../ref/mathlive/src/public/mathlive-ssr';
...
describe('Static Elements Rendering Functions', () => {
  describe('convertLatexToMarkup', () => {
    it('should convert LaTeX to markup in textstyle mode', () => {
      ...
      expect(markup).toContain('lm_latex');
  ...
  describe('Options handling', () => {
    ...
    it('should respect maxMatrixCols option', () => {
      ...
      expect(markup).toBeTruthy();
      expect(markup).toContain('lm_mtable'); // matrix table
    });
  });
