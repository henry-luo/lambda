...
The upstream Jest/Playwright tests do not directly test Lambda: they call MathLive APIs. Use the adapter runner to render the MathLive markup snapshot formulas through `lambda/doc/math` instead.
