...
} from '../../../ref/mathlive/src/public/mathlive-ssr';
...
test('Unsecure Content', () => {
  ...
  expect(
    ...
    '<span class="lm_latex"><span class="lm_strut" style="height:0.44em"></span><span class="lm_base"><span data-x="&quot; ><img/onerror=alert(1) src>"><span class="lm_mathit">x</span></span></span></span>'
  );
...
test('Secure Content', () => {
  ...
  expect(convertLatexToMarkup('\\href{http://example.com}{x}')).toMatch(
    '<span class="lm_latex"><span class="lm_strut" style="height:0.44em"></span><span class="lm_base"><span href="http://example.com"><span class="lm_mathit">x</span></span></span></span>'
  );

  // Gets turned into a data-onerror attribute, so safe
  expect(convertLatexToMarkup('\\htmlData{onerror=alert(1)}{x}')).toMatch(
    '<span class="lm_latex"><span class="lm_strut" style="height:0.44em"></span><span class="lm_base"><span data-onerror="alert(1)"><span class="lm_mathit">x</span></span></span></span>'
  );
});
