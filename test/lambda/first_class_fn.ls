...
[
    ...
    apply_fn(double_dyn, 7), // Test 5a: HOF with double -> 14
    apply_fn(triple_dyn, 5), // Test 5b: HOF with triple -> 15
    apply_fn(square, 6),     // Test 5c: HOF with square -> 36
