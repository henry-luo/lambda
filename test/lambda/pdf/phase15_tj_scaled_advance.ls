// Phase 15 — TJ positioning advances by effective scaled font size.
...
pn main() {
    let ops = [
        ...
        { op: "Tm", operands: [2, 0, 0, 2, 10, 20] },
        { op: "TJ", operands: [arr([str("A"), -700, str("B")])] },
        { op: "ET", operands: [] }
    ]
