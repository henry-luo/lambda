...
struct SimEvent {
    ...
    bool has_expected_active_target;
    bool expected_active_target;
    bool has_expected_drag_target;
    bool expected_drag_target;
    bool has_expected_drag_active;
    bool expected_drag_active;
    bool has_expected_drag_drop;
    bool expected_drag_drop;
    bool has_expected_drag_drop_pending;
    bool expected_drag_drop_pending;
    bool has_expected_drag_drop_active;
    bool expected_drag_drop_active;
    bool has_expected_drag_drop_source;
