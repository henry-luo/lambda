...
- **G4 — Concurrency unimplemented.** The model is stated (J4); nothing is built. The value-semantics dividend — and the differentiation against GraalVM (1.5) — remains unclaimed.
