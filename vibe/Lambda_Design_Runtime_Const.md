...
| **RC2** | **Eligibility is bounded by the AST interpreter's evaluation capability, gated by purity.** Any expression the T0 interpreter can evaluate is a fold candidate; **D6.1.2**'s purity bit decides whether it *may* be folded. Not a hand-maintained node-shape whitelist. |
