...
> **Ledger series**: extends the DOM area's `ES#`/`ESO#`/`F#` per `doc/Doc_Convention.md` §4. Decisions **ES39–ES44**; open issues **ESO84–ESO106** (ESO81, ESO93, ESO101 and ESO106 resolved) (ESO81, ESO93 and ESO101 resolved); stages **F28–F33**.
