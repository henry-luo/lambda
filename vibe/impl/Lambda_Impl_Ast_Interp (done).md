...
**Date:** 2026-09-06 (rev 70 — **satellite write-back: indexed/member stores and untyped `var` parameters promote through the CW33 home transport (D8.1.1v6, §3.0.58)**; rev 69 widened admission to `any` parameters and local `var`/assignment)
