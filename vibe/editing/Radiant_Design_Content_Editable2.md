...
> **Superseded — 2026-07-29.** This historical proposal's legacy-command and
> marker-routing material is not current product behavior. Radiant exposes no
> `execCommand`/`queryCommand*` API; see
