...
**Execution-policy revision (USER, 2026-09-16; revised 2026-09-22):** **D8.1.3v13 / JSI16v2**
...
five) to a boxed MIR satellite; whole-module MIR fallback is not a promotion.
This is governed by **D8.1.3v13** and **D8.5.1v4**.
...
**Formal authority:** **D1.1–D1.10**, **D4.1.1v2**, **D4.1.4v4**, **D4.5.1v3**, **D4.6.1v2–D4.6.2v2**, **D5.1.1–D5.1.4**, **D5.3.2–D5.3.4**, **D5.4.1–D5.4.4**, **D6.2.1–D6.2.4**, **D6.3.1**, **D7.2.1**, **D8.1.1v5**, **D8.1.3v13**, **D8.2.1–D8.2.6**, **D8.4.1v2**, **D8.4.3v2**, and **D8.6.1–D8.6.4v2** in [`doc/Lambda_Formal_Design.md`](../doc/Lambda_Formal_Design.md). The formal specification wins on disagreement.
...
mode, including for diagnostics or large/cold modules (**D8.1.3v13**).
...
Under **D8.1.3v13** (USER, 2026-09-16; revised 2026-09-22), the AST walker is LambdaJS's interpreter;
...
differential tests select each backend explicitly (**D8.1.3v13**).
...
therefore accepts only a synchronous classic top-level declaration with no
captures or module/global binding reads, calls, property access, compound
literals/patterns, nested callable, class, `this`, `arguments`, `new.target`,
`eval`, or `with`. The satellite context is retained in the owning
`EvalContext` until teardown. Every other definition is pinned to T0.
...
5. Preserve the native-only MIR contract across promotion and retained artifacts;
   ...
   than deferred to this promotion phase (**D8.1.3v13**).
...
| **JSI16v2** | Selected LambdaJS MIR executes native code; AST is the interpreter | ratified USER 2026-09-16 / D8.1.3v13; implementation pending JS Tune13 |
| **JSI17** | T0 support is semantic-fact-aware and decided before declaration instantiation | proposed |
| **JSI18** | Promotion happens only at function entry; no general OSR | implemented for the closed P2 slice / D8.1.3v13 |
