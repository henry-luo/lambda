...
[JS_MVP_Release_Acceptance_20260915.md](../../test/benchmark/JS_MVP_Release_Acceptance_20260915.md).
...
python3 test/benchmark/run_benchmarks.py \
  ...
  --results-output temp/js_mvp_release_session<N>.json
```
...
The generated [Markdown report](../../test/benchmark/JS_MVP_Release_Acceptance_20260915.md)
and [machine summary](../../test/benchmark/JS_MVP_Release_Acceptance_20260915.json)
...
python3 test/benchmark/report_js_mvp_result.py \
  --session temp/js_mvp_release_final_session1.json \
  --session temp/js_mvp_release_final_session2.json \
  --output test/benchmark/JS_MVP_Release_Acceptance_20260915.md \
  --json-output test/benchmark/JS_MVP_Release_Acceptance_20260915.json
```
...
## 7. Review findings and remaining product boundary
