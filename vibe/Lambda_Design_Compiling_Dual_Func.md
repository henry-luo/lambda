...
> Related: [`Lambda_Design_Compiling.md`](Lambda_Design_Compiling.md) (LC1v2: no
> inline caches in Lambda script **or LambdaJS** — §10 multi-version dispatches
> via guard chain, never caches),
