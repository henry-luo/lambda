...
The `DomElement::pseudo_state` bitfield should remain as a fast render/style cache, but updates should flow from StateStore transition functions. That gives tests and logs a single place to observe truth.
