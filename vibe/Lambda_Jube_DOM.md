...
- Remaining Phase 2 work: broad tree/layout/style methods, style/CSSOM, broader document proxy/window cases, true live collection wrappers, Range/Selection, geometry, and broader element/form setters remain on JS fallback.
