...
ViewPage* create_latex_page(int page_number, ViewSize page_size) {
    ...
    // Set content area (with 1 inch margins)
    page->content_area.origin.x = 72.0;
    page->content_area.origin.y = 72.0;
    page->content_area.size.width = page_size.width - 144.0;  // subtract left + right margins
    page->content_area.size.height = page_size.height - 144.0; // subtract top + bottom margins
    
    // Set margin area (the full page)
    page->margin_area.origin.x = 0.0;
    page->margin_area.origin.y = 0.0;
    page->margin_area.size.width = page_size.width;
    page->margin_area.size.height = page_size.height;
