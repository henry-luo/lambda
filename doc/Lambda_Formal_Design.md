...
**Spec version:** 1.31.0 (2026-08-26)
...
- **D8.1.3v3*** LambdaJS has an explicit, boxed AST interpreter backend. A
  ...
  class, and call kernels. Direct and indirect `eval` calls are admitted.
