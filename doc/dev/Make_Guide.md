...
| `test-js-coverage` | Build and run `test_js_gtest`, Test262, and the LambdaJS benchmark scripts under `test/benchmark/` with LLVM source coverage; writes HTML and metadata under `test/coverage/js/`. |
