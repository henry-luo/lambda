...
5. **One polyglot family.** The Jube runtimes (Python/Bash/Ruby, `lambda/module/py|lambda/bash|lambda/module/rb/`) follow the same pattern: Tree-sitter front-end → MIR lowering → shared Item/GC/JIT ([Lambda_Jube_Runtime](../Lambda_Jube_Runtime.md)).
