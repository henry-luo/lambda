...
- **Exceptions:** no C++ exceptions/longjmp — D8.4.3 routes each returned ERROR-tagged Item through `jm_emit_error_lane_propagate_check`; stack overflow alone uses a signal + `sigsetjmp` recovery ([JS_04 §9](js/JS_04_MIR_Lowering.md)).
