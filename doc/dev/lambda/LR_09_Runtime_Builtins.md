...
Moved to the central ledger: **[Lambda Core Runtime — Central Issue Ledger](../../../vibe/Lambda_Issue_Ledger.md)**, entries **LR09-1 – LR09-9** (LR09-8/9 were found during verification, not extracted from this section) (open/partial) and **LR09-R1** (resolved, Appendix A).
