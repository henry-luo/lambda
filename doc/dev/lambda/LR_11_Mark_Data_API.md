...
- **Type sharing.** Maps built the same way share one `TypeMap` through the per-`Input` transition tree (D3.4.3v2). Parsed elements and `MarkEditor` rebuilds share the same way; nothing is pooled any more.
