...
| `lambda/lambda.h` | Numeric helper macros: `i2it`, `INT53_MIN`/`INT53_MAX`, `INT64_ERROR`, `DECIMAL_BIGINT`, `DATETIME_MAKE_ERROR`, the decimal/datetime boxing macros (`c2it`/`k2it`). |
