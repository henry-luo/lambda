...
- [RAD_18 — Editing, Selection & DOM Ranges](RAD_18_Editing_Selection_Ranges.md) — the rich `contenteditable` path and the Stage 4B native-engine retirement this doc contrasts against; shares the projection-cache cleanup path.
