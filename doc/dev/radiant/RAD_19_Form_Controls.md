...
| `radiant/text_control.{cpp,hpp}` | UTF-8↔UTF-16 conversions, `tc_ensure_init`/`tc_set_value`/`tc_set_selection_range`, `tc_sync_selection_to_form`, `selectionchange` coalescing, active/focused text-control tracking. |
