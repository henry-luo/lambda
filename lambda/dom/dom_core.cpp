...
DOM_ENGINE_SEAM_0(clipboard_copy_event)
...
DOM_ENGINE_SEAM_2(bind_model_edit_surface)
DOM_ENGINE_SEAM_2(finish_model_edit)
DOM_ENGINE_SEAM_1(is_focusable)
DOM_ENGINE_SEAM_4(dispatch_event)
DOM_ENGINE_SEAM_1(keyboard_click)
DOM_ENGINE_SEAM_2(keyboard_command)
...
DOM_ENGINE_SEAM_2(set_close_guard)
DOM_ENGINE_SEAM_1(request_window_close)
DOM_ENGINE_SEAM_2(set_window_title)
...
DOM_ENGINE_SEAM_1(capture_pointer)
DOM_ENGINE_SEAM_2(input_operation)
DOM_ENGINE_SEAM_3(set_range_from_point)
