...
import aria: lambda.dom.aria
import ime: lambda.dom.ime
import menu: lambda.dom.menu
import caret: lambda.dom.caret
import keymap: lambda.dom.keymap
import scroll: lambda.dom.scroll
import focus: lambda.dom.focus
import mouse: lambda.dom.mouse
import dom_edit: lambda.dom.dom_edit
import commands: lambda.dom.commands
import design_mode: lambda.dom.edit_design_mode
import submit: lambda.dom.submit
import details: lambda.dom.details
import keyboard: lambda.dom.keyboard
import stepper: lambda.dom.stepper
...
on edit_commit(evt) { editing.commit_change(~) }
