...
enum ts_symbol_identifiers {
    ...
    sym_symbol = 58,
    aux_sym__symbol_content = 59,
    sym__expression = 60,
    sym_primary_expr = 61,
    sym_spread_element = 62,
    sym_call_expr = 63,
    sym_subscript_expr = 64,
    sym_member_expr = 65,
    sym_binary_expr = 66,
    sym_unary_expr = 67,
    sym_parameter = 68,
    ...
    aux_sym__list_item_repeat1 = 77,
    aux_sym_list_stam_repeat1 = 78,
    aux_sym_lit_map_repeat1 = 79,
    aux_sym_map_repeat1 = 80,
    aux_sym_lit_array_repeat1 = 81,
    aux_sym_array_repeat1 = 82,
    aux_sym__arguments_repeat1 = 83,
    aux_sym_fn_definition_repeat1 = 84,
    aux_sym_let_expr_repeat1 = 85,
    aux_sym_for_expr_repeat1 = 86,
};
