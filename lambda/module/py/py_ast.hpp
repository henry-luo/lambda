...
static const PyAstNodeType PY_AST_NODE_WHILE = AST_NODE_LOOP;
...
static const PyOperator PY_OP_MATMUL = OPERATOR_PY_MATMUL;
...
static const PyOperator PY_OP_NOT_IN = OPERATOR_PY_NOT_IN;
static const PyOperator PY_OP_IS = OPERATOR_IS;
static const PyOperator PY_OP_IS_NOT = OPERATOR_PY_IS_NOT;
...
static const PyOperator PY_OP_FLOOR_DIV_ASSIGN = OPERATOR_PY_FLOOR_DIV_ASSIGN;
...
static const PyOperator PY_OP_MATMUL_ASSIGN = OPERATOR_PY_MATMUL_ASSIGN;
...
static const PyLiteralType PY_LITERAL_INT = AST_LITERAL_PY_INT;
static const PyLiteralType PY_LITERAL_FLOAT = AST_LITERAL_PY_FLOAT;
