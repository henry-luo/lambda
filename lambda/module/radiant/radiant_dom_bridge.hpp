...
RADIANT_C_API Item fn_radiant_velmt_attr(Item velmt_item, Item name_item, Item default_item);
...
RADIANT_C_API Item fn_radiant_velmt_style(Item velmt_item, Item name_item, Item default_item);
