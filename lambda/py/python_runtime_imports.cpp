...
static const JubeRuntimeImport python_runtime_imports[] = {
    ...
    {"py_mark_mir_public_abi", FPTR(py_mark_mir_public_abi)},
    ...
    {"py_call_function_into", FPTR(py_call_function_into)},
    {"py_call_function_kw", FPTR(py_call_function_kw)},
    {"py_call_function_kw_into", FPTR(py_call_function_kw_into)},
