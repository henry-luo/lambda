...
enum ts_symbol_identifiers {
  ...
  sym__expression = 69,
  sym_primary_expr = 70,
  sym_spread_element = 71,
  sym_call_expr = 72,
  sym_subscript_expr = 73,
  sym_member_expr = 74,
  sym_binary_expr = 75,
  sym_binary_no_relation_expr = 76,
  sym_unary_expr = 77,
  sym_parameter = 78,
  sym_fn_definition = 79,
  sym_assign_expr = 80,
  sym_let_expr = 81,
  sym_let_stam = 82,
  sym_if_expr = 83,
  ...
  aux_sym__content_item_repeat1 = 87,
  aux_sym__content_repeat1 = 88,
