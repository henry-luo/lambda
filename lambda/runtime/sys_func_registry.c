...
#undef JS_TEST262_REGISTRY_ENTRY
    ...
    {"js_array_set_append_or_dense_int_fast", FPTR(js_array_set_append_or_dense_int_fast)},
    {"js_array_set_append_or_dense_item_fast", FPTR(js_array_set_append_or_dense_item_fast)},
