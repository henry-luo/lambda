...
#undef JS_TEST262_REGISTRY_ENTRY
    ...
    {"js_eval_local_export_var", FPTR(js_eval_local_export_var), JIT_IMPORT_VOID_PRESERVES},
    ...
    {"js_262_eval_script_is_active", FPTR(js_262_eval_script_is_active), JIT_IMPORT_RAW_SCALAR_PRESERVES},
