...
static const RuntimeResourceDescriptor runtime_resource_descriptors[] = {
    ...
    {RUNTIME_RESOURCE_TLS_SERVER, RUNTIME_RESOURCE_GROUP_NETWORK, "TLSServerWrap"},
    {RUNTIME_RESOURCE_HTTP_SERVER, RUNTIME_RESOURCE_GROUP_NETWORK, "HTTPServerWrap"},
    {RUNTIME_RESOURCE_HTTP_CONNECTION, RUNTIME_RESOURCE_GROUP_NETWORK, "HTTPConnectionWrap"},
    {RUNTIME_RESOURCE_HTTP_CLIENT, RUNTIME_RESOURCE_GROUP_NETWORK, "HTTPClientRequest"},
