...
static CssProperty property_definitions[] = {
    ...
    // Shorthand properties would be defined here with longhand_props arrays
    // For brevity, not including all shorthand expansions in this example
};

static const int PROPERTY_DEFINITION_COUNT = sizeof(property_definitions) / sizeof(property_definitions[0]);
