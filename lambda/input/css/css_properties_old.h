...
#include "css_sty// Functio#include "css_style.h"
...
typedef CssValueType CSSPropertyType;ns (compatibility layer using css_style.h types)
...
#define css_property_enhanced_validate_value css_property_validate_valuede "../../../lib/mempool.h"
...
// Legacy function aliases
#define css_property_enhanced_validate_value css_property_validate_value

// Function declarations (minimal compatibility layer)
CSSPropertyID css_property_id_from_name(const char* name);
const char* css_property_name_from_id(CSSPropertyID id);
CSSPropertyType css_property_get_expected_type(CSSPropertyID id);
bool css_property_validate_value(CSSPropertyID id, CSSPropertyValue* value);
