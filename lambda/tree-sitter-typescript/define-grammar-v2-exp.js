...
module.exports = function defineGrammar(dialect) {
  return grammar(JavaScript, {
    ...
    rules: {
      ...
      // method_signature, abstract_method_signature — removed
      // (externalized: parsed by C++ interface body parser or not needed for runtime class bodies)
      ...
      // mapped_type_clause, omitting/adding/opting_type_annotation — removed
      // (externalized: parsed by C++ interface body parser)
