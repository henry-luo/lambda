...
-Werror=sign-compare -Werror=implicit-function-declaration -Werror=return-type \
-Werror=format -Werror=free-nonheap-object -Werror=shadow -Werror=array-bounds -Werror=implicit-function-declaration \
