...
project "test_layout_baseline_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    targetname "test_layout_baseline_gtest"
    targetextension ".exe"
    
    files {
        "test/test_layout_baseline_gtest.cpp",
    }
...
project "test_view_cmd_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    targetname "test_view_cmd_gtest"
    targetextension ".exe"
    
    files {
        "test/test_view_cmd_gtest.cpp",
    }
