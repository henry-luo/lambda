...
project "test_layout_auto"
    ...
    files {
        "test/layout/tools/test_layout_auto.cpp",
        "test/layout/tools/layout_test_framework.cpp",
        "test/layout/tools/html_css_parser.cpp",
        "test/layout/tools/css_radiant_mapper.cpp",
        "test/layout/tools/viewblock_builder.cpp",
        "radiant/flex_layout_new.cpp",
        "radiant/layout_test_support.cpp",
    }
