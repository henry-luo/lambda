...
project "lambda"
    ...
    files {
        ...
        "lambda/input/html5_tokenizer.cpp",
        "lambda/input/input-org.cpp",
        "lambda/input/html5_parser.cpp",
        ...
        "lambda/input/html5_tree_construction.cpp",
...
project "test_element_reader_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    ...
    files {
        "test/test_element_reader_gtest.cpp",
        "lambda/element_reader.cpp",
        "lambda/element_reader_utils.cpp",
    }
...
project "test_html5_parser_infra_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    targetname "test_html5_parser_infra_gtest"
    targetextension ".exe"
    
    files {
        "test/test_html5_parser_infra_gtest.cpp",
        "lambda/input/html5_parser.cpp",
    }
...
project "test_html5_tokenizer_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    targetname "test_html5_tokenizer_gtest"
    targetextension ".exe"
    
    files {
        "test/test_html5_tokenizer_gtest.cpp",
        "lambda/input/html5_tokenizer.cpp",
    }
...
project "test_html5_tree_construction_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    targetname "test_html5_tree_construction_gtest"
    targetextension ".exe"
    
    files {
        "test/test_html5_tree_construction_gtest.cpp",
        "lambda/input/html5_parser.cpp",
        "lambda/input/html5_tokenizer.cpp",
        "lambda/input/html5_tree_construction.cpp",
    }
