...
project "test_flex_layout_gtest"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    ...
    files {
        "test/test_flex_layout_gtest.cpp",
        "test/flex_test_support.cpp",
        "radiant/flex_layout_new.cpp",
    }
...
project "test_flex_new_features"
    kind "ConsoleApp"
    language "C++"
    targetdir "test"
    objdir "build/obj/%{prj.name}"
    ...
    files {
        "test/test_flex_new_features.cpp",
        "test/flex_test_support.cpp",
        "radiant/flex_layout_new.cpp",
    }
